...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About PlayerCoin", Q_NULLPTR));
        label->setText(QApplication::translate("AboutDialog", "<b>PlayerCoin</b> version", Q_NULLPTR));
...
"Copyright \302\251 2017 The PlayerCoin developers", Q_NULLPTR));
