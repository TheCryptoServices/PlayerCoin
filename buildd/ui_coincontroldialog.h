...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 PLACO"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 PLACO"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 PLACO"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 PLACO"));
