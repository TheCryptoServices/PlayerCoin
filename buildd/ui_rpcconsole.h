...
public:
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "PlayerCoin - Debug window", Q_NULLPTR));
        label_9->setText(QApplication::translate("RPCConsole", "PlayerCoin Core", Q_NULLPTR));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the PlayerCoin debug log file from the current data directory. This can take a few seconds for large log files.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the PlayerCoin-Qt help message to get a list with possible PlayerCoin command-line options.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
